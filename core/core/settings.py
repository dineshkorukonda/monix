...
# django-axes: rate-limit admin login attempts
...
#
# Uses DATABASE_URL environment variable when set (shared with Flask).
# Falls back to a local SQLite database for development without PostgreSQL.
