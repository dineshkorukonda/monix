  ...
  const sections = [
    {
      ...
      title: "OVERVIEW",
      content:
        "MONIX WEB IS A COMPREHENSIVE WEB SECURITY ANALYSIS PLATFORM THAT PROVIDES REAL-TIME URL SCANNING, SSL CERTIFICATE VALIDATION, DNS INTELLIGENCE, AND THREAT DETECTION. BUILT ON THE MONIX-CORE SECURITY SYSTEM, IT DELIVERS INSTANT VULNERABILITY ASSESSMENT AND SECURITY SCORING FOR ANY DOMAIN OR URL.",
    },
    {
      id: "architecture",
      title: "ARCHITECTURE",
