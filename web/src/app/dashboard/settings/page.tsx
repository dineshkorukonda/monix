  ...
  return (
    <div className="space-y-8 max-w-4xl pt-4">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">Configure your localized Monix interface and manage high-level account access.</p>
      </div>
      ...
      <div className="grid gap-8">
            ...
            <CardContent className="grid gap-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">Select how Monix strictly renders across the HUD.</p>
                </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">Default processing language applied to structural security reports.</p>
                </div>
                <select className="h-9 w-full md:w-48 rounded-md border border-input bg-background/50 px-3 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
        ...
        {/* Danger Zone */}
        <div className="grid gap-4">
          <h3 className="text-sm font-semibold tracking-wide uppercase text-destructive ml-1">Danger Zone</h3>
            ...
            <CardContent className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-6">
              <div className="space-y-1 pb-1">
                ...
                <p className="text-sm text-muted-foreground max-w-[400px] leading-relaxed">
                  Permanently destroy this dashboard, including all active scan historical data, tracked targets, and API bindings. <strong className="text-foreground">This cannot be undone.</strong>
                </p>
              </div>
              <Button variant="destructive" className="shrink-0 font-semibold shadow-sm">Purge Account</Button>
            </CardContent>
          </Card>
        </div>
